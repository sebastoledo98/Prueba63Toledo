...
a persistence unit "practica1PersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "practica1/pom.xml":
...
artifact ("practica1.war") is already built. You can build
